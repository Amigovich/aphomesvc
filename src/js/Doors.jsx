  ...
  return (
    <div>
      <Container className="mt-5">
        ...
        <p className="text-center">Upgrade your home's entryways with high-quality door replacement and installation solutions. Choose from a variety of door types, including Entry, French & Hinged, Patio or Sliding, and Storm & Screen doors. Our trusted partners include <a href="https://www.andersenwindows.com/windows-and-doors/doors/" target="_blank" rel="noopener noreferrer" style={{ textDecoration: "none" }}>Andersen</a>, <a href="https://www.marvin.com/products/doors" target="_blank" rel="noopener noreferrer" style={{ textDecoration: "none" }}>Marvin</a>, and <a href="https://www.kolbewindows.com/doors" target="_blank" rel="noopener noreferrer" style={{ textDecoration: "none" }}>Kolbe</a>, ensuring top-notch quality and durability.</p>
