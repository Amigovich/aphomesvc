...
const HomePage = () => {
    ...
    return (
        <div className="home-page" style={backgroundStyle}>
            <div className="content-box" style={{ backgroundColor: 'rgba(255, 255, 255, 0.9)', padding: '20px', borderRadius: '10px', maxWidth: '600px', width: '100%' }}>
                <h1 className="text-center" style={{ color: "black" }}>Welcome to AP Home Services</h1>
